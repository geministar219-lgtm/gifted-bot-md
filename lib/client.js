// ============================================================
// SUHAIL-MD – Version "Demande immédiate" pour Railway
// Numéro : 237698730509
// ============================================================
...
async function startBot() {
    ...
    // ===== DEMANDER LE CODE IMMÉDIATEMENT =====
    ...
    if (!creds || !creds.registered) {
        ...
        try {
            ...
            // Si la demande échoue, on réessaie dans 5 secondes
            setTimeout(async () => {
                try {
                    const code = await sock.requestPairingCode(PHONE_NUMBER);
                    console.log(`📱 CODE : ${code}`);
                    ...
                    console.error('❌ Échec de la deuxième tentative :', err.message);
                }
            }, 5000);
        }
    } else {
